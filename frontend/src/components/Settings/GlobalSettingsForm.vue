...
<style scoped>
.settings-section { margin-block-end: 2rem; }
.success { color: green; margin-inline-start: 1rem; }
.error { color: red; margin-inline-start: 1rem; }
form > div { margin-block-end: 1rem; }
.modal { background: #fff; border: 1px solid #ccc; padding: 1rem; position: fixed; inset-block-start: 20%; inset-inline-start: 50%; transform: translate(-50%, 0); z-index: 1000; }
</style> 